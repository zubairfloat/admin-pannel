            ...
            <div className="card-header media border-0 pb-0">
              <div className="media-body">
                <h2 className="text-black">
                  56 <span className="text-success fs-14">+4%</span>
                </h2>
        ...
        <div className="col-xl-3 col-lg-6 col-sm-6">
          <div className="card overflow-hidden">
            <div className="card-header media border-0 pb-0">
              <div className="media-body">
                <h2 className="text-black">
                  785 <span className="text-success fs-14">+2.7%</span>
                </h2>
        ...
        <div className="col-xl-3 col-lg-6 col-sm-6">
          <div className="card overflow-hidden">
            <div className="card-header media border-0 pb-0">
              <div className="media-body">
                <h2 className="text-black">
                  56 <span className="text-danger fs-14">-3%</span>
                </h2>
        ...
        <div className="col-xl-3 col-lg-6 col-sm-6">
          <div className="card overflow-hidden">
            <div className="card-header media border-0 pb-0">
              <div className="media-body">
                <h2 className="text-black">
                  $6231 <span className="text-danger fs-14">-3.7%</span>
                </h2>
            ...
            <div className="card-body p-0">
              <div className="table-responsive ">
                <table className="table order-request ">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          <Link
                            to={"#"}
                            className="btn bgl-success text-success"
                          >
                            DELIVERED
                          </Link>
                          <Dropdown>
                    ...
                    <tr>
                          ...
                          <div className="media-body">
                            <h5 className="mt-0 mb-2">
                              <Link
                                ...
                                className="text-black"
                              >
                                Sweet Cheezy Pizza for Kids Meal (Small Size)
                              </Link>
                            </h5>
                            <p className="mb-0 text-primary">#0010235</p>
                          </div>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          <Link to={"#"} className="btn bgl-light">
                            CANCELED
                          </Link>
                          <Dropdown>
                            <Dropdown.Toggle
                ...
                <div className="card-footer border-0 pt-0 text-center">
                  <Link to={"/ecom-product-list"} className="btn-link">
                    View More &gt;&gt;
                  </Link>
                </div>
              </div>
